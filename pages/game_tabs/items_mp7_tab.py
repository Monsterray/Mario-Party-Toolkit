...
class ItemsMP7Tab(QWidget):
    ...
    def create_item_group(self, item_name, icon_path, item_key):
        ...
        price1_entry.setPlaceholderText("1P")
        ...
        price2_entry.setPlaceholderText("2P")
        ...
        price34_entry.setPlaceholderText("34P")
        ...
        space1_entry.setPlaceholderText("1P")
        ...
        space2_entry.setPlaceholderText("2P")
        ...
        space34_entry.setPlaceholderText("34P")
